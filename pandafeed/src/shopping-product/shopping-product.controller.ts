...
export class ShoppingProductController {
  constructor(private readonly shoppingProductService: ShoppingProductService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateShoppingProductDto: UpdateShoppingProductDto) {
